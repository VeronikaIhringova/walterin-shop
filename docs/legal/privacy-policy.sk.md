...
Posledná aktualizácia: 22. septembra 2026

Tieto zásady vysvetľujú, ako spoločnosť Walterin s. r. o. spracúva osobné údaje, keď navštívite walterin.com, požiadate o upozornenie na produkt, prihlásite sa na odber newslettera, objednáte si tovar alebo nás kontaktujete.
...
E-mail: support@walterin.com
Telefón: +421 905 549 907

Zodpovednú osobu sme nevymenovali. S akoukoľvek otázkou o vašich osobných údajoch nám napíšte na support@walterin.com.

## 2. Čo spracúvame, prečo, na akom právnom základe a ako dlho

### 2.1 Návšteva webovej stránky

- **Údaje:** IP adresa, informácie o zariadení a prehliadači, navštívené stránky, dátum a čas prístupu a údaje uložené v cookies a podobných technológiách (pozri časť 4).
- **Účel:** zobrazenie webovej stránky, jej bezpečnosť a funkčnosť a zapamätanie si vašich nastavení (napríklad jazyka, košíka a voľby cookies).
- **Právny základ:** náš oprávnený záujem na prevádzke bezpečnej a funkčnej stránky (čl. 6 ods. 1 písm. f) GDPR). Pri cookies a podobných technológiách, ktoré nie sú nevyhnutné: váš súhlas (čl. 6 ods. 1 písm. a) GDPR; § 109 zákona č. 452/2021 Z. z. o elektronických komunikáciách).
- **Doba uchovávania:** nevyhnutné cookies po dobu uvedenú v lište cookies. Ostatné údaje, kým sú potrebné na daný účel, ako je uvedené v týchto zásadách.

### 2.2 Prihlásenie na upozornenie („Upozorniť ma“)

- **Údaje:** e-mailová adresa. Zaznamenávame aj produkt a jazykovú edíciu, na ktoré ste sa prihlásili.
- **Účel:** poslať vám jednorazové upozornenie, keď bude produkt dostupný. **Nejde** o prihlásenie na odber newslettera. Na základe tohto prihlásenia vám nebudeme posielať newsletter ani inú marketingovú komunikáciu.
- **Právny základ:** váš súhlas (čl. 6 ods. 1 písm. a) GDPR), ktorý udeľujete odoslaním formulára.
- **Doba uchovávania:** do uplynutia 3 mesiacov od odoslania upozornenia alebo do odvolania súhlasu, podľa toho, čo nastane skôr. Potom prihlásenie vymažeme, ak ste sa medzitým nestali naším zákazníkom alebo odberateľom newslettera na inom základe.
...
### 2.4 Objednávky, platba a doručenie

- **Údaje:** meno, e-mail, telefónne číslo, fakturačná a doručovacia adresa, objednané produkty, cena, spôsob a stav platby, údaje o doručení a sledovaní zásielky a komunikácia k objednávke. Úplné čísla platobných kariet nedostávame ani neuchovávame.
- **Účel:** uzavretie a plnenie kúpnej zmluvy, prijatie platby, doručenie tovaru (vrátane zaslania odkazu na stiahnutie e-knihy) a zasielanie oznámení o objednávke a odoslaní.
...
- **Účel:** vybavenie odstúpenia od zmluvy, reklamácií a vašich otázok vrátane otázok zaslaných cez kontaktný formulár.
...
- **Účel:** meranie výsledkov našej reklamy na Facebooku a Instagrame a zobrazovanie relevantnej reklamy.
- **Právny základ:** váš súhlas s marketingovými cookies v lište cookies (čl. 6 ods. 1 písm. a) GDPR; § 109 zákona č. 452/2021 Z. z.). Tieto nástroje pri vás použijeme, len ak ste tento súhlas udelili.
...
Cookies sú malé súbory uložené vo vašom prehliadači. Používame:
...
Zákaznícke údaje nášho obchodu sú uložené v Európskej únii. Niektorí poskytovatelia ich však môžu spracúvať aj mimo Európskeho hospodárskeho priestoru: Shopify (najmä Kanada, USA a Singapur), Stripe (najmä USA) a Meta (USA). Pri týchto prenosoch sa poskytovatelia podľa vlastných vyhlásení opierajú o rozhodnutie Európskej komisie o primeranosti (pre Kanadu a pre americké spoločnosti certifikované v rámci EU–U.S. Data Privacy Framework, čl. 45 GDPR) alebo o primerané záruky, napríklad štandardné zmluvné doložky alebo záväzné vnútropodnikové pravidlá (čl. 46 – 47 GDPR). Viac informácií o týchto zárukách vám poskytneme na support@walterin.com.
...
- na ich opravu (čl. 16);
- na ich vymazanie (čl. 17);
- na obmedzenie spracúvania (čl. 18);
- na prenosnosť údajov (čl. 20);
- **namietať** spracúvanie založené na našom oprávnenom záujme (čl. 21);
- **kedykoľvek odvolať súhlas**. Odvolanie nemá vplyv na spracúvanie pred jeho odvolaním (čl. 7 ods. 3).

Svoje práva uplatníte e-mailom na support@walterin.com. Odpovieme do jedného mesiaca. V prípadoch podľa čl. 12 ods. 3 GDPR sa táto lehota môže predĺžiť.

Máte tiež právo podať sťažnosť dozornému orgánu, najmä v členskom štáte EÚ, kde žijete alebo pracujete. Na Slovensku je to Úrad na ochranu osobných údajov Slovenskej republiky, Hraničná 12, 820 07 Bratislava 27, https://dataprotection.gov.sk. Ak žijete v Spojenom kráľovstve, môžete sa obrátiť aj na Information Commissioner's Office (https://ico.org.uk).

## 7. Je poskytnutie údajov povinné?

Údaje potrebné na uzavretie a plnenie kúpnej zmluvy (meno, kontaktné a doručovacie údaje) sú zmluvnou požiadavkou. Bez nich objednávku neprijmeme. Poskytnutie údajov pri prihlásení na upozornenie a na odber newslettera je dobrovoľné.

Nepoužívame automatizované rozhodovanie vrátane profilovania, ktoré by malo voči vám právne účinky alebo by vás podobne významne ovplyvňovalo.

## 8. Deti

Obchod nie je určený deťom mladším ako 16 rokov. Ich osobné údaje vedome nezískavame.
