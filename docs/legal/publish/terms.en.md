...
Valid and effective from: [DÁTUM ZVEREJNENIA]
...
2.2 The buyer is a consumer: a natural person who, when concluding and performing the contract, is not acting for purposes of their trade, business or profession ("the buyer" or "you"). If the buyer is not a consumer, the provisions of these Terms and of consumer protection law that protect consumers do not apply to them.
...
3.3 For delivery outside the European Union, the destination country may charge customs duties, import taxes or fees. These are paid by the buyer unless stated otherwise at checkout.
...
4. you place the order with a button that clearly states the obligation to pay (for example "Pay now").
...
4.3 After you place the order, we send you an order confirmation by email without undue delay. **The contract is concluded when you receive this confirmation.**
...
5.1 You can pay by card (Visa, Mastercard, American Express, JCB, Discover, Diners Club), Apple Pay or Google Pay. Payments are processed by Stripe.
...
6.1 We show you the available delivery countries, methods and prices at checkout before you place the order.

6.2 Unless agreed otherwise, we deliver the goods no later than 30 days after the contract is concluded.

6.3 If we do not deliver the goods within the agreed time, you may set a reasonable additional period. If we do not deliver within that period either, you may withdraw from the contract.

6.4 The risk of damage to or loss of the goods passes to you when you receive the goods from the carrier.

6.5 On delivery, check that the parcel is intact. If it is visibly damaged, tell the carrier and write to us at support@walterin.com. This does not limit your rights for defects.

## 7. Delivery of eBooks

7.1 We deliver the eBook as a download link sent by email after payment.

7.2 eBooks are in PDF or EPUB format. To open them you need a device and an application that support these formats.
...
- online via the **"Withdraw from contract here"** function in the footer of every page of the store (https://walterin.com/pages/withdrawal); we will send you an acknowledgement of receipt by email, including its content and the date and time of its submission, without undue delay;
...
8.7 If you withdraw from a contract under which we supplied an eBook, you may no longer use it or make it available to third parties.
