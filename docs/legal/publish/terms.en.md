...
Last updated: [DÁTUM ZVEREJNENIA] (effective from the same day)
...
- you place the order with a button that clearly states the obligation to pay (for example "Pay now").
...
If you withdraw from a contract under which we supplied an eBook, you may no longer use it or make it available to third parties.
