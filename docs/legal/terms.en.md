...
Valid and effective from: [TO FILL – publication date]

> DRAFT for legal review. Square brackets = information to fill in or confirm before publishing. Translation of the Slovak original (vop.sk.md).
...
Registered in the Commercial Register of the Municipal Court Bratislava III, section Sro, file no. 193235/B
Email: support@walterin.com, phone: +421 905 549 907
("the seller" or "we")

Supervisory authority: Slovak Trade Inspection (Slovenská obchodná inšpekcia, SOI), SOI Inspectorate for the Bratislava Region, Bajkalská 21/A, P. O. BOX č. 5, 820 07 Bratislava, Slovakia, https://www.soi.sk

## 2. Introduction

2.1 These terms and conditions ("Terms") set out the rights and obligations of the seller and the buyer when buying goods and digital content through the online store walterin.com ("the store").

2.2 The buyer is a consumer: a natural person who, when concluding and performing the contract, is not acting for purposes of their trade, business or profession ("the buyer" or "you"). If the buyer is not a consumer, the provisions of these Terms and of consumer protection law that protect consumers do not apply to them. [TO CONFIRM – lawyer: sales to businesses yes/no]

2.3 We sell:
- **goods**, for example tarot cards, printed books, stickers and clothing ("goods");
- **digital content** not supplied on a tangible medium, in particular eBooks in PDF or EPUB format for download ("eBook").

2.4 Contracts are concluded in Slovak or English. The Slovak version of these Terms is binding.
...
3.4 For discounted prices we also show the lowest price at which we offered the item in the 30 days before the discount. [TO CONFIRM – lawyer; set up in the store before the first sale]
...
4.3 After you place the order, we send you an order confirmation by email without undue delay. **The contract is concluded when you receive this confirmation.** [TO CONFIRM – lawyer]

4.4 The order confirmation contains the content of the contract, these Terms, the withdrawal instructions and the model form (or links to them) and, for eBooks, confirmation of your consent under clause 4.2. It is the confirmation of the contract on a durable medium. We archive the contract (order); its details are in your order confirmation.

4.5 We may refuse or cancel an order before performance, in particular if the goods are not available or the price was obviously wrong. In that case we refund everything you paid without undue delay, and within 14 days at the latest.

## 5. Payment

5.1 You can pay by card (Visa, Mastercard, American Express, JCB, Discover, Diners Club), Apple Pay or Google Pay. Payments are processed by Stripe. [TO FILL – PayPal, only once active]

5.2 You pay in advance when placing the order.

5.3 We do not offer cash on delivery or cash payment.

## 6. Delivery of goods

6.1 Delivery countries, carriers, prices and delivery times are set out in the **Shipping Policy** [TO FILL – link to Shipping policy]. We add new delivery countries only by updating the Shipping Policy.

6.2 We dispatch goods [TO FILL – Pack4you: dispatch time]. Unless agreed otherwise, we deliver the goods no later than 30 days after the contract is concluded.

6.3 [TO FILL – pre-orders: only if pre-orders are decided; state the expected delivery date and what happens in case of delay.]

6.4 If we do not deliver the goods within the agreed time, you may set a reasonable additional period. If we do not deliver within that period either, you may withdraw from the contract. [TO CONFIRM – lawyer: reference to the relevant provision]

6.5 The risk of damage to or loss of the goods passes to you when you receive the goods from the carrier.

6.6 On delivery, check that the parcel is intact. If it is visibly damaged, tell the carrier and write to us at support@walterin.com. This does not limit your rights for defects.

## 7. Delivery of eBooks

7.1 We deliver the eBook as a download link sent by email after payment. The link is also available on the order confirmation page. [TO FILL – number of downloads and link validity as set in the Digital Products app]

7.2 eBooks are in PDF or EPUB format. To open them you need a device and an application that support these formats. [TO FILL – functionality, compatibility and technical protection, if any]

7.3 The eBook is for your personal use only. You may not share, sell or make it available to others. Copyright in the text and illustrations belongs to the author.
